...
- 7410f6b: chore: version packages - @netanelh2/create-playwright-project@4.0.1
...
- cfd61d3: fix: add --write flag to lint-staged Biome command
...
- 0da65b2: chore: simplify lint-staged configuration
...
- 392eb10: docs: update package documentation to reflect current package.json scripts
