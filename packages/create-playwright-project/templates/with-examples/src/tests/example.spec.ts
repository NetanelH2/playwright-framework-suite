...
test.describe('Example Page Tests @sanity', () => {
  test('should load the page and display main elements', async ({
    examplePage,
  }) => {
  ...
  test('should navigate through different sections', async ({
    examplePage,
  }) => {
    await examplePage.navigateTo();
    await examplePage.validatePageLoaded();
...
test.describe('Example Page Tests @regression', () => {
  ...
  test('should display correct content in different sections', async ({
    examplePage,
  }) => {
    await examplePage.navigateTo();
